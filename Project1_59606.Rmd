...
We can store our summary statistics to later examine it further.
```{r}
...
Diagnostic trace plots and density plots. 
...
##Bayesian factor estimation without bridge sampler
